...
class mdarray(object):
    ...
    def T(self, axis1=0, axis2=1):
        swap_item(self.strides, axis1, axis2)
        swap_item(self.shape, axis1, axis2)
        return self
    ...
    def __radd__(self, other):
        apply_binary_function(other, self, operator.add)
        return self
    ...
    def __rsub__(self, other):
        apply_binary_function(other, self, operator.sub)
        return self
    ...
    def __rmul__(self, other):
        apply_binary_function(other, self, operator.mul)
        return self
    ...
    def __rtruediv__(self, other):
        apply_binary_function(other, self, operator.truediv)
        return self
    ...
    def __rfloordiv__(self, other):
        apply_binary_function(other, self, operator.floordiv)
        return self
    ...
    def __rpow__(self, power, modulo=None):
        apply_binary_function(power, self, operator.pow)
        return self
    ...
    def __arctan2__(self, other):
        return apply_binary_function(self, other, math.atan2)
...
def tomdarray(arr):
    if isinstance(arr, mdarray):
        ...
        if isinstance(arr, list):
            arr, _, shape = flatten_list(arr, order=-1)
            mdarr = mdarray(shape=shape, data=arr)
        elif isinstance(arr, dict):
            mdarr = [[i, j] for i, j in arr.items()]

        return tomdarray(mdarr)
